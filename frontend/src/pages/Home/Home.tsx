...
const Home: React.FC = () => {
  return (
    <>
      {/* Topo com logo e ícone de perfil */}
      ...
      <div className="pagina">
        <div className="conteudo-principal">
          <div className="texto">
            <p>
              <strong>Waves of Technology: Sustentabilidade e Consciência no Consumo de Água Potável</strong>
              <br /><br />
          ...
          <div className="imagem">
            <img src={imagemTexto} alt="Imagem sobre sustentabilidade hídrica" />
          </div>
        </div>

        <p className="segundo-paragrafo">
          🌊💧 <strong>Junte-se ao Waves of Technology e Faça a Diferença!</strong>
          <br /><br />
          ...
          <br />
          - Responda o nosso quiz e descubra como otimizar seu consumo de água.<br />
          - Divulgue nossas iniciativas e espalhe a conscientização.<br />
          - Adote hábitos sustentáveis e inspire quem está ao seu redor.<br /><br />
